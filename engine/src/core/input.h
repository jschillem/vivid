...
typedef enum keys {
  ...
  DEFINE_KEY(LEFT_WINDOWS, 0x5B),
  DEFINE_KEY(RIGHT_WINDOWS, 0x5C),
  ...
  DEFINE_KEY(NUM_LOCK, 0x90),
  DEFINE_KEY(SCROLL_LOCK, 0x91),
